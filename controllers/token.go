...
// 	req_token := r.Header.Get("refreshtoken")
// 	if req_token == "" {
...
// 	user, err := q.GetUserByEmail(context.Background(), payload.UserID)
// 	switch {
...
// 	access_token, err := token.CreateAccessToken(payload.UserID)
// 	if err != nil {
// 		helpers.ErrorResponse(w, "error issuing new acces token", 500)
// 		return
// 	}

// 	refresh_token, err := token.CreateRefreshToken(payload.UserID)
// 	if err != nil {
