...
func (q *Queries) DeleteWorkspaceUser(ctx context.Context, workspaceUserID string) error {
...
func (q *Queries) GetWorkspaceUser(ctx context.Context, workspaceUserID string) (WorkspaceUser, error) {
...
func (q *Queries) GetWorkspaceUsersByWorspaceID(ctx context.Context, workspaceID string) ([]WorkspaceUser, error) {
...
func (q *Queries) UpdateAcceptedInvitationStatus(ctx context.Context, workspaceUserID string) error {
