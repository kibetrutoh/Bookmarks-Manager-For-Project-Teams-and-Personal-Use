...
ALTER TABLE IF EXISTS dashboard DROP CONSTRAINT foreign_key_to_plan_table;
ALTER TABLE IF EXISTS dashboard_member DROP CONSTRAINT foreign_key_to_dashboard_role_table;
